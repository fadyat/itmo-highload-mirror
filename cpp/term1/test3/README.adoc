[![Review Assignment Due Date](https://classroom.github.com/assets/deadline-readme-button-22041afd0340ce965d47ae6ef1cefeee28c7c493a6346c4f15d667ab976d596c.svg)](https://classroom.github.com/a/oajRagyn)
...
* Решение должно быть header-only, размещено в namespace `control_03`
...
** про другие элементы STL — уточняйте
...
* Поддержим этот сценарий, добавив:

=== emplace

Метод `emplace`, инициализирующий внутреннее значение напрямую переданными аргументами
...
Специальная форма конструктора - `maybe(in_place_t, ...)`:

* таким же образом передающая аргументы на конструирование значения внутри
...
maybe<my_class> mb{in_place_t, arg1, arg2, ...};
