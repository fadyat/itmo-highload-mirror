...
impl Block {
    ...
    fn compute_hash_inner(
        ...
        hasher.update(attrs.issuer.public_key.n().to_le_bytes());
        hasher.update(attrs.issuer.public_key.e().to_le_bytes());
...
impl Transaction {
    pub fn verified(self) -> Result<VerifiedTransaction> {
        ...
        self.sender
            .public_key
            .verify(Pkcs1v15Sign::new_unprefixed(), &hash, &self.signature)?;
    ...
    pub fn compute_hash(&self) -> TransactionHash {
        ...
        hasher.update(self.sender.public_key.n().to_le_bytes());
        hasher.update(self.sender.public_key.e().to_le_bytes());
        hasher.update(self.receiver.public_key.n().to_le_bytes());
        hasher.update(self.receiver.public_key.e().to_le_bytes());
...
impl VerifiedTransaction {
    ...
    pub fn sign(
        ...
        transaction.signature = sender.sign(Pkcs1v15Sign::new_unprefixed(), &hash)?;
