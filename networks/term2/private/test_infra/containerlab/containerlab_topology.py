...
class ContainerlabTopology:
    ...
    def __init__(
        ...
        self.topology_name_prefix = topology_name_prefix
        self.new_topology_path = self.workdir / self.topology_file_name
        self.topology_file_set_up = False
        self.new_topology_name = None

    def setup_topology_file(self):
    ...
    def get_new_topology_name(self):
