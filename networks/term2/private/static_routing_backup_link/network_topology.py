...
from test_infra.containerlab.network_objects import Route, Interface, Host, Cluster
...
def get_known_hosts() -> Sequence[str]:
    return tuple(host.name for host in CLUSTER.hosts)
